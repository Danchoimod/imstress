        ...
        return `
            <div class="col-6 col-md-4 col-lg-3" id="fav-item-${videoId}">
                <div class="card video-card">
                    <img src="${posterUrl}" class="card-img-top" alt="Thumbnail ${videoTitle}" onclick="window.location.href='${VIDEO_DETAIL_BASE_URL}${videoId}'">
                    <div class="video-card-body d-flex justify-content-between align-items-center">
                        <div class="video-card-title" onclick="window.location.href='${VIDEO_DETAIL_BASE_URL}${videoId}'">${videoTitle}</div>
