...
<body>
    ...
    <script>
    const videoUrlID = (new URLSearchParams(window.location.search)).get('catId');
    const VIDEO_API_URL = "${pageContext.request.contextPath}/api/videobycat?catId=" + videoUrlID;
