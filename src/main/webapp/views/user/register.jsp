...
<style>
/* CSS giữ nguyên */
body { background: #181f36; min-height: 100vh; }
.bg-overlay { background: rgba(24, 31, 54, 0.95); min-height: 100vh; display: flex; align-items: center; justify-content: center; }
.card-custom { background: #232b4a; border-radius: 24px; box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.37); color: #fff; padding: 40px 32px 32px 32px; min-width: 380px; max-width: 400px; }
.btn-custom { background: #ffe082; color: #232b4a; font-weight: 600; border: none; border-radius: 8px; transition: background 0.2s; }
.btn-custom:hover { background: #ffd54f; }
.btn-back { background: transparent; color: #b0b8d1; font-weight: 600; border: 1px solid #2c3557; border-radius: 8px; transition: all 0.2s; text-align: center; padding: 10px 12px; display: block; text-decoration: none; }
.btn-back:hover { background: #2c3557; color: #fff; border-color: #ffe082; }
.logo { display: flex; align-items: center; margin-bottom: 32px; }
.logo-icon { width: 48px; height: 48px; margin-right: 12px; }
.logo-text { font-size: 1.5rem; font-weight: bold; color: #ffe082; }
.logo-desc { font-size: 1rem; color: #b0b8d1; }
.form-label { color: #b0b8d1; }
.form-control { background: #1a2036; color: #fff; border: 1px solid #2c3557; border-radius: 8px; }
.form-control:focus { background: #232b4a; color: #fff; border-color: #ffe082; box-shadow: none; }
.text-link { color: #ffe082; text-decoration: none; }
