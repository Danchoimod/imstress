...
<nav class="navbar navbar-expand-lg fixed-top" style="background:#11121a;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarContent">
      <!-- FORM TÌM KIẾM CẬP NHẬT -->
      <form class="d-flex mx-3 flex-grow-1" role="search" style="max-width:420px;" id="searchForm" onsubmit="handleSearch(event)">
        ...
        <button class="search-submit-btn" type="submit">
          <svg viewBox="0 0 24 24" fill="none">
            ...
            <path d="M20 20l-3.5-3.5" stroke="#222" stroke-width="2" stroke-linecap="round"/>
          </svg>
        </button>
      </form>
...
<script>
    ...
    function handleSearch(event) {
        ...
        window.location.href = contextPath + '/search?q=' + encodeURIComponent(keyword);

        return false;
    }

    // ============= CATEGORY LOADING (Giữ nguyên) =============
    const contextPath = '${pageContext.request.contextPath}';
